...
export default function AuthModal() {
  ...
  const [confirmPasswordInscription, setConfirmPasswordInscription] =
    useState<string>();
  ...
  const handleSubmit = async () => {
    ...
    const endpoint = authMode === "login" ? "/auth/login" : "/auth/register";
       ...
       const bodyData =
      authMode === "login"
        ? { email: emailConnexion, password: passwordConnexion }
        : {
          ...
          {(onClose) => (
            <>
                ...
                {authMode === "login" ? (
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex justify-end">
                      <Link className="text-[#003E7E] cursor-pointer" size="sm">
                        Mot de passe oublié ?
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setConfirmPasswordInscription(e.target.value)
                      }
                    />
                    <div className="flex flex-col gap-2">
                      ...
                      >
                        ...
                        <Link
                          href="#"
                          className="text-tiny text-[#003E7E] underline"
                        >
              ...
              <ModalFooter className="flex flex-col gap-3">
                <Button
                  className="bg-[#003E7E] text-white w-full"
